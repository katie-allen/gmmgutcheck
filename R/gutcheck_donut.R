#' Good Mythical Morning donut scores
#'
#' Gut check scores from the Good Mythical Morning episode "We Tried EVERY Krispy Kreme Donut Flavor".
#'
...
#' }
#' @source \url{https://www.youtube.com/watch?v=GsK5NaSCkho}
"gutcheck_donut"