#' Good Mythical Morning Pop-Tart scores
#'
#' Gut check scores from the Good Mythical Morning episode "We Tried EVERY Pop-Tarts Flavor".
#'
...
#' }
#' @source \url{https://youtu.be/XPEPROdBOfE}
"gutcheck_poptart"