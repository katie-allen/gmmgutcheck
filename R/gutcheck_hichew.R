#' Good Mythical Morning Hi-Chew scores
#'
#' Gut check scores from the Good Mythical Morning episode "We Tried EVERY Hi-Chew Flavor".
#'
...
#' }
#' @source \url{https://youtu.be/ytxGUHQ5ZNY}
"gutcheck_hichew"