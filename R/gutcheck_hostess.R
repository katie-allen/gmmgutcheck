#' Good Mythical Morning Hostess cake scores
#'
#' Gut check scores from the Good Mythical Morning episode "We Try EVERY Hostess Cake Flavor".
#'
...
#' }
#' @source \url{https://youtu.be/HVq-o5dL6jk}
"gutcheck_hostess"