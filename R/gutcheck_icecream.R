#' Good Mythical Morning ice cream scores
#'
#' Gut check scores from the Good Mythical Morning episode "We Tried EVERY Ben & Jerry's Ice Cream Flavor".
#'
...
#' }
#' @source \url{https://youtu.be/athYDVmzZWc}
"gutcheck_icecream"